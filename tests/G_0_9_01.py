...
class WeightedSumSingle(step.Fn):
    def __init__(self, input, output):
        super().__init__("WeightedSumSingle", input, output)
...
fn_wssingle = WeightedSumSingle(step.STuple((step.Scalar("float"), step.Scalar("float"))), step.Scalar("float"))
    

class WeightedSumDouble(step.Fn):
    def __init__(self, input, output):
        super().__init__("WeightedSumDouble", input, output)
...
fn_wsdouble = WeightedSumDouble(step.STuple((step.Buffer(step.Scalar("float"), [D]), step.Scalar("float"), step.Scalar("float"))), step.Buffer(step.Scalar("float"), [D]))
...
fn_div = Div(step.STuple((step.Scalar("float"), step.Buffer(step.Scalar("float"), [D]))), step.Buffer(step.Scalar("float"), [D]))
